...
| **Invalidate** | The whole note is no longer current; keep history visible | `/strata:invalidate` |
...
```bash
/strata:invalidate domain/old-aggregate-pattern.md \
...
Two signals flag notes for likely correction.
...
Neither auto-corrects. Both surface in review for you to decide
